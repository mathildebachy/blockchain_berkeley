                ...
                <Header />
                    <Col md={6} xl={8}>
                        <Card className='Recent-Users'>
                            <Card.Header>
                                <Card.Title as='h1'>Pending Approvals</Card.Title>
                            </Card.Header>
                                ...
                                <Table responsive hover>
                                    ...
                                    <tr className="unread">
                                        ...
                                        <td>
                                            ...
                                            <p className="m-0">Master of Financial Engineering</p>
                                        </td>
                                        <td>
                                    ...
                                    <tr className="unread">
                                        ...
                                        <td>
                                            ...
                                            <p className="m-0">Bachelor of Arts</p>
                                        </td>
                                        <td>
                                    ...
                                    <tr className="unread">
                                        ...
                                        <td>
                                            ...
                                            <p className="m-0">Master of Engineering</p>
                                        </td>
                                        <td>
